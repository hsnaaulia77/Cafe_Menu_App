...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Tambah Promo Baru</h1>
            </div>
            <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                          ...
                                          placeholder="Deskripsi detail promo">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('jenis') is-invalid @enderror" 
                                    ...
                                    <option value="diskon_persen" {{ old('jenis') == 'diskon_persen' ? 'selected' : '' }}>
                                        Diskon Persentase
                                    </option>
                                    <option value="diskon_nominal" {{ old('jenis') == 'diskon_nominal' ? 'selected' : '' }}>
                                        Diskon Nominal
                                    </option>
                                    <option value="voucher" {{ old('jenis') == 'voucher' ? 'selected' : '' }}>
                                        Voucher/Kupon
                                    </option>
                                    <option value="bundle" {{ old('jenis') == 'bundle' ? 'selected' : '' }}>
                                        Promo Bundle
                                    </option>
                                </select>
                                @error('jenis')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="nilai_prefix">Rp</span>
                                    </div>
                                ...
                                <small class="form-text text-muted" id="nilai_help">
                                    Masukkan nilai diskon dalam rupiah atau persentase
                                </small>
                                @error('nilai')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <!-- Kode Kupon -->
                            <div class="form-group" id="kode_kupon_group" style="display: none;">
                                <label for="kode_kupon">Kode Kupon</label>
                                <input type="text" class="form-control @error('kode_kupon') is-invalid @enderror" 
                                       id="kode_kupon" name="kode_kupon" value="{{ old('kode_kupon') }}" 
                            ...
                            <!-- Menu Bundle -->
                            <div class="form-group" id="menu_bundle_group" style="display: none;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" 
                                                   ...
                                                   value="{{ $menu->id }}" 
                                                   {{ in_array($menu->id, old('menu_bundle', [])) ? 'checked' : '' }}>
